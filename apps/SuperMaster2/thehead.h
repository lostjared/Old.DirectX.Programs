...
public:
	...
	virtual void load()
	{
		...
		mxhwnd.LoadSound(&sintro,MAKEINTRESOURCE(IDR_WAVE2));
		play = false;
	}
...
private:
	...
	public:
		...
		virtual void load()
		{
			...
			credits[1].set("Music by dEEp Logic ",RGB(255,0,0));
	...
	private:
		...
		struct Credit
		{
			...
			inline void set(char* xstr,COLORREF colorx)
			{
				strcpy(str,xstr);
				color = colorx;
				x = 200;
...
public:
	...
	virtual void load()
	{
		...
		mxhwnd.LoadSound(&sfire,MAKEINTRESOURCE(IDR_WAVE1));
...
private:
	...
	inline void draw()
	{
		...
		mxhwnd.text.sprinttext(10,10," SuperMaster - %s - Score (%i) - Lives (%i) - Kills (%i)",level.level_name,score,lives,kills);
		drawmap();
	}
...
private:
	...
	inline void draw()
	{
		...
		mxhwnd.text.sprinttext(20,180," Now Entering Level (%i) - press enter key to continue",cur_level);
