...
// enumerated constats
enum { ID_INTRO = 1 , ID_START, ID_GAME, ID_HIGHSCORES, ID_ABOUT, ID_ENTERLEVEL, ID_USERWON };
...
public:
	...
	virtual void load()
	{
		for(i = 0; i < 10; i++)
		{
			images[i].SetColorKey(RGB(255,255,255));
			images_l[i].SetColorKey(RGB(255,255,255));
		}
...
public:
	...
	virtual void load()
	{
		...
		bullet.SetColorKey(RGB(255,255,255));
